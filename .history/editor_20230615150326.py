...
def check_collision(rect, level, scroll):
    for item in level:
        ...
        elif rect != item.rect and item.rect.colliderect(rect) and (item.rect.left > pygame.mouse.get_pos()[0] + scroll[0] or item.rect.right < pygame.mouse.get_pos()[0] + scroll[0]):

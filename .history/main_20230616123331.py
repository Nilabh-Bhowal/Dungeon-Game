...
def collide(player, rooms):
    for room in rooms:
        if player.rect.colliderect(room):
            ...
            if not pl and player.rect.left <= room.rect.left + 6:
                player.rect.left = room.rect.left + 5
            elif not pr and player.rect.right >= room.rect.right - 2:
                player.rect.left = room.rect.right - player.rect.width - 5

            if not pu and player.rect.top <= room.rect.top + 2:
                player.rect.top = room.rect.top + 5
            elif not pd and player.rect.bottom >= room.rect.bottom - 2:
                player.rect.top = room.rect.bottom - player.rect.height - 5

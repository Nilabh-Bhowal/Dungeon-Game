    ...
    for room in rooms:
        if room != current_room:
            ...
            pl = player.rect.x - player.rect.width < room.rect.x + room.rect.width \
                ...
                and player.rect.y >= room.rect.y \
                and player.rect.y + player.rect.height < room.rect.y + room.rect.height
            pr = player.rect.x + 2 * player.rect.width > room.rect.x \
                and player.rect.x + player.rect.width < room.rect.x + room.rect.width and player.rect.y >= room.rect.y and player.rect.y + \

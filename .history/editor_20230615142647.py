...
while running:
    ...
    if pygame.mouse.get_pos()[0] <= 980 and pygame.mouse.get_pressed()[0] and not pressed:
        ...
        if current_item == "room":
            level.append(dungeon.DungeonRoom(pygame.mouse.get_pos()[0] + scroll[0], pygame.mouse.get_pos()[1] + scroll[1]))
        elif current_item == "corridor":
            level.append(dungeon.Corridor(pygame.mouse.get_pos()[0] + scroll[0], pygame.mouse.get_pos()[1] + scroll[1]))

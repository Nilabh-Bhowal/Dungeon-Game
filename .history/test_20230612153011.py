...
def check_passability(player, current_room, rooms):
    for room in rooms:
        if room != current_room:
            ...
            pr = player.rect.x + 2 * player.rect.width > room.rect.x and player.rect.x < room.rect.x + room.rect.width and player.rect.y >= room.rect.y and player.rect.y + player.rect.height <= room.rect.y + room.rect.height
            print(player.rect.x + 2 * player.rect.width > room.rect.x and not player.rect.x > room.rect.x)
            return pu, pd, pl, pr

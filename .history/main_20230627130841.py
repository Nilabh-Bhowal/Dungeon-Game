...
class Enemy(entity.Entity):
    ...
    def move(self, player, rooms):
        ...
        if not self.near_player:
            ...
            self.movement = [0, 0]
        elif player.rect.left < self.rect.left - 20:
            self.movement[0] = -1
        elif player.rect.right > self.rect.right + 20:
            self.movement[0] = 1
        elif player.rect.top < self.rect.top - 20:
            self.movement[1] = -1
        elif player.rect.bottom > self.rect.bottom + 20:
            self.movement[1] = 1
        else:
            self.movement = [0, 0]

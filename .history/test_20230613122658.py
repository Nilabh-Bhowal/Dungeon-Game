...
def check_passability(player, current_room, rooms):
    for room in rooms:
        if room != current_room:
            ...
            pl = player.rect.x - player.rect.width < room.rect.x + room.rect.width and player.rect.x > room.rect.x + room.rect.width - player.rect.width and player.rect.y >= room.rect.y and player.rect.y + player.rect.height <= room.rect.y + room.rect.height

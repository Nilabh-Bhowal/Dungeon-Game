...
def collide(player, rects):
    for rect in rects:
        player.rect.x = max(player.rect.x, rect.x)
        player.rect.x = min(player.rect.x, rect.x + rect.width - player.rect.width)
        player.rect.y = max(player.rect.y, rect.y)
        player.rect.y = min(player.rect.y, rect.y + rect.height - player.rect.height)

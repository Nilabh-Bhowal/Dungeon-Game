...
def collide(player, rooms):
    for room in rooms:
        if player.rect.colliderect(room):
            ...
            if not pl:
                player.rect.x = max(player.rect.x, room.rect.x + 1)
            if not pr:
                player.rect.x = min(player.rect.x, room.rect.x + room.rect.width - player.rect.width - 1)
            if not pu:
                player.rect.y = max(player.rect.y, room.rect.y + 1)
            if not pd:
                player.rect.y = min(player.rect.y, room.rect.y + room.rect.height - player.rect.height - 1)

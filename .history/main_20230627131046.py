...
class Enemy(entity.Entity):
    ...
    def move(self, player, rooms):
        ...
        elif player.rect.left < self.rect.left - 6:
            self.movement[0] = -1
        elif player.rect.right > self.rect.right + 6:
            self.movement[0] = 1
        elif player.rect.top < self.rect.top - 6:
            self.movement[1] = -1
        elif player.rect.bottom > self.rect.bottom + 6:
            self.movement[1] = 1
        else:
            self.movement = [0, 0]
